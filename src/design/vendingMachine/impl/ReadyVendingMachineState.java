...
public class ReadyVendingMachineState implements VendingMachineState {
	...
	private VendingMachineAction nextValidAction =  VendingMachineAction.PICK_ITEM;
	
	public ReadyVendingMachineState(){
		this.allowedActions.add(VendingMachineAction.REFILL_ITEMS);
		this.allowedActions.add(VendingMachineAction.INSERT_COIN);
	}
