 ...
 */
public class TextJustificationSimple {
    ...
    private int findRight(int left, String[] words, int maxWidth) {
        ...
        while (right+1 < words.length && (sum + 1 + words[right+1].length()) <= maxWidth) {
    ...
    public static void main(String[] args) {
        TextJustificationSimple jus = new TextJustificationSimple();
