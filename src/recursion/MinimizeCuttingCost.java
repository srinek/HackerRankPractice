...
/*
 * http://qa.geeksforgeeks.org/4063/qa.geeksforgeeks.org/4063/minimize-the-cutting-cost-latest-google-question.html
 * 
 * 
...
Notes: 
- Sequence a1, a2 ,…, an is lexicographically smaller than b1, b2 ,…, bm, if and only if at the first i where ai and bidiffer, ai < bi, or if no such i found, then n < m.
- N can be upto 109.
 ...
 */
public class MinimizeCuttingCost {

	
	private static int[] minimizeCost(int[] a, int length){
